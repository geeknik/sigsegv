...
public abstract class BaseLocation
{
    ...
    public static string GetLocationName(GameLocation location)
    {
        return location switch
        {
            GameLocation.MainStreet => Loc.Get("location.main_street"),
            GameLocation.TheInn => Loc.Get("location.inn"),
            GameLocation.DarkAlley => Loc.Get("location.dark_alley"),
            GameLocation.Church => Loc.Get("location.church"),
            GameLocation.WeaponShop => Loc.Get("location.weapon_shop"),
            GameLocation.ArmorShop => Loc.Get("location.armor_shop"),
            GameLocation.Bank => Loc.Get("location.bank"),
            GameLocation.AuctionHouse => "Auction House",
            GameLocation.Dungeons => Loc.Get("location.dungeon"),
            GameLocation.Castle => Loc.Get("location.castle"),
            GameLocation.Dormitory => Loc.Get("location.dormitory"),
            GameLocation.AnchorRoad => Loc.Get("location.anchor_road"),
            GameLocation.Temple => Loc.Get("location.temple"),
            GameLocation.BobsBeer => "Bob's Beer",
            GameLocation.Healer => Loc.Get("location.healer"),
            GameLocation.MagicShop => Loc.Get("location.magic_shop"),
            GameLocation.Master => Loc.Get("location.level_master"),
            _ => location.ToString()
        };
    }
    ...
    public virtual string GetLocationDescription()
    {
        return LocationId switch
        {
            GameLocation.MainStreet => "command district",
            GameLocation.TheInn => "safehouse",
            GameLocation.DarkAlley => "outside the dead drop",
            GameLocation.Church => "old chapel",
            GameLocation.Dungeons => "subnet",
            GameLocation.WeaponShop => "armory",
            GameLocation.Master => "training node",
            GameLocation.MagicShop => "exploit exchange",
            GameLocation.ArmorShop => "hardening lab",
            GameLocation.Bank => "crypto vault",
            GameLocation.Healer => "patch clinic",
            GameLocation.AuctionHouse => "Auction House",
            GameLocation.Dormitory => "crash pods",
            GameLocation.AnchorRoad => "anchor link",
            GameLocation.BobsBeer => "Bobs Beer",
            GameLocation.Castle => "admin tower",
            GameLocation.Prison => "detention block",
            GameLocation.Temple => "sanctuary",
            _ => Name
        };
    }
